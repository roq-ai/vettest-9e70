  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience seamless pet care with vettest - your comprehensive vet management system. Create and manage customer profiles, upload files, and add detailed notes to pet records - everything a hospital offers, now for your pets."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless pet care with vettest - your comprehensive vet management system. Create and manage customer profiles, upload files, and add detailed notes to pet records - everything a hospital offers, now for your pets.`}
            </Text>
            <Box
